    ...
    <section class="px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2">
      ...
      <div>
        ...
        <p class="text-gray-600 w-3/5 mx-auto">
          ...
          global variables that can be passed around.This is a atentive prop
          drilling. Becuse GrandFather to grandSon conection attactment
          proses.The parents is also Children data analisis posible for props
          comming. so props is alwayes drilling GrandFather to parents and
          Childrens . It is very HelpFull.
        </p>
